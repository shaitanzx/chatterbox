...
def prepare_environment():
    ...
    torch_command = os.environ.get('TORCH_COMMAND',
                                   f"pip install torch==2.5.1 torchaudio==2.5.1 torchvision==0.20.1 --extra-index-url {torch_index_url}")
    requirements_file = os.environ.get('REQS_FILE', "requirements-nvidia.txt")
